...
<form method="post" action="../database/data_update.php">
<table>
	...
	<tr><td>Username</td><td>:  <input type="text" name="username" placeholder="username" disabled="true" value="<?php echo selecting("username"); ?>"></td><td rowspan="4"><textarea name="deskripsi" rows="10" cols="60"><?php echo selecting("deskripsi");?></textarea></td></tr>
